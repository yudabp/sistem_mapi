                    ...
                    <div class="space-y-8">
                        ...
                        <div>
                            ...
                            <ul class="mt-3">
                                ...
                                <!-- Keuangan Perusahaan -->
                                <li class="pl-4 pr-3 py-2 rounded-lg mb-0.5 last:mb-0" x-data="{ open: {{ (Request::is('financial*') || Request::is('keuangan-perusahaan') || Request::is('keuangan-perusahaan/buku-kas') || Request::is('keuangan-perusahaan/data-hutang')) ? 1 : 0 }} }" x-init="if ('{{ (Request::is('financial*') || Request::is('keuangan-perusahaan') || Request::is('buku-kas') || Request::is('data-hutang')) }}' == '1') open = true">
                                    <a class="block text-gray-800 dark:text-gray-100 truncate transition {{ (Request::is('financial*') || Request::is('keuangan-perusahaan') || Request::is('keuangan-perusahaan/buku-kas') || Request::is('keuangan-perusahaan/data-hutang')) ? '' : 'hover:text-gray-900 dark:hover:text-white' }}" href="#" @click.prevent="open = !open; sidebarExpanded = true">
                                        <div class="flex items-center justify-between">
                                            <div class="flex items-center">
                                                <svg class="shrink-0 fill-current {{ (Request::is('financial*') || Request::is('keuangan-perusahaan') || Request::is('keuangan-perusahaan/buku-kas') || Request::is('keuangan-perusahaan/data-hutang')) ? 'text-violet-500' : 'text-gray-400 dark:text-gray-500' }}" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24">
                                            ...
                                            <div class="flex shrink-0 ml-2 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">
                                                <svg class="w-3 h-3 shrink-0 ml-1 fill-current text-gray-400 dark:text-gray-500 {{ (Request::is('financial*') || Request::is('keuangan-perusahaan') || Request::is('keuangan-perusahaan/buku-kas') || Request::is('keuangan-perusahaan/data-hutang')) ? 'rotate-180' : 'rotate-0' }}" :class="open ? 'rotate-180' : 'rotate-0'" viewBox="0 0 12 12">
                                    ...
                                    <div class="lg:hidden lg:sidebar-expanded:block 2xl:block">
                                        <ul class="pl-8 mt-1 {{ (Request::is('financial*') || Request::is('keuangan-perusahaan') || Request::is('keuangan-perusahaan/buku-kas') || Request::is('keuangan-perusahaan/data-hutang')) ? 'hidden' : 'block' }}" :class="open ? 'block!' : 'hidden'">
                                            ...
                                            <li class="mb-1 last:mb-0">
                                                <a class="block text-gray-500/90 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200 transition truncate {{ Request::is('financial.cash-book') || Request::is('keuangan-perusahaan/buku-kas') ? 'text-violet-500!' : '' }}" href="{{ route('buku-kas') }}">
                                                    <span class="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">Buku Kas</span>
                                                </a>
                                            </li>
                                            <li class="mb-1 last:mb-0">
                                                <a class="block text-gray-500/90 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200 transition truncate {{ Request::is('financial.debts') || Request::is('keuangan-perusahaan/data-hutang') ? 'text-violet-500!' : '' }}" href="{{ route('data-hutang') }}">
