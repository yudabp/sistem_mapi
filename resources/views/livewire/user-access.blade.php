<div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
    ...
    <div class="bg-white dark:bg-gray-800 rounded-sm border border-gray-200 dark:border-gray-700 shadow-sm mb-8">
        ...
        <div class="p-5">
            <div class="text-center py-10">
                ...
                <h3 class="text-xl font-bold text-gray-800 dark:text-gray-100 mb-2">Manajemen Akses User</h3>
                <p class="text-gray-600 dark:text-gray-400 mb-6">
                    Kelola akun user, peran, dan izin untuk sistem manajemen perkebunan kelapa sawit.
                </p>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-sm border border-gray-200 dark:border-gray-700 shadow-sm">
        <div class="px-5 py-4 border-b border-gray-100 dark:border-gray-700/60">
            <h2 class="font-semibold text-gray-800 dark:text-gray-100">Informasi User Saat Ini</h2>
        </div>
        <div class="p-5">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <div class="flex items-center text-sm text-gray-500 dark:text-gray-400">
                                ...
                                <span>Anggota sejak {{ Auth::user()->created_at->format('M Y') }}</span>
                            </div>
                        </div>
                        <div>
                            <div class="bg-gray-50 dark:bg-gray-700/30 rounded-lg p-4">
                                <h4 class="font-medium text-gray-800 dark:text-gray-100 mb-2">Status Akun</h4>
                                ...
                                <p class="text-sm text-gray-600 dark:text-gray-400 mt-2">
                                    Akun Anda dalam kondisi baik dan memiliki akses penuh ke semua fitur sistem.
                                </p>
                            </div>
                        </div>
                    </div>
