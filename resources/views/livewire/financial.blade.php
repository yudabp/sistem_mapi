            ...
            <div class="mt-4 grid grid-cols-2 gap-2">
                <div>
                    ...
                    <input 
                        ...
                        class="w-full px-2 py-1 text-xs border {{ $errors->has('startDate') ? 'border-red-500' : 'border-gray-300' }} dark:border-gray-600 rounded shadow-sm focus:outline-none focus:ring-1 focus:ring-violet-500 focus:border-violet-500 dark:bg-gray-700 dark:text-gray-300"
                        x-data
                        x-init="
                ...
                <div>
                    ...
                    <input 
                        ...
                        placeholder="DD-MM-YYYY"
                        class="w-full px-2 py-1 text-xs border {{ $errors->has('endDate') ? 'border-red-500' : 'border-gray-300' }} dark:border-gray-600 rounded shadow-sm focus:outline-none focus:ring-1 focus:ring-violet-500 focus:border-violet-500 dark:bg-gray-700 dark:text-gray-300"
                        x-data
                        x-init="
                            $el.addEventListener('input', function(e) {
                                let input = e.target.value.replace(/\D/g, '');
                ...
                <div class="flex flex-wrap gap-2">
                    ...
                    <div class="relative group">
                        ...
                        <div class="absolute right-0 mt-0 w-48 bg-white dark:bg-gray-800 rounded-md shadow-lg py-1 z-10 hidden group-hover:block">
                            ...
                            <a 
                                href="{{ route('financial.sample.download') }}"
                                class="block w-full text-left px-4 py-2 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 flex items-center gap-2"
                            >
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
