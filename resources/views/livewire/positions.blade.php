<div>
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
        ...
        <div class="mb-8 flex justify-between items-center">
            <div>
                <h1 class="text-2xl md:text-3xl text-gray-800 dark:text-gray-100 font-bold">Jabatan</h1>
                <p class="text-sm text-gray-600 dark:text-gray-400 mt-1">Master data jabatan perusahaan</p>
            </div>
            <button
        ...
        <div class="bg-white dark:bg-gray-800 rounded-sm border border-gray-200 dark:border-gray-700 shadow-sm mb-6 p-6">
            <div class="flex flex-col sm:flex-row gap-4">
                <div class="flex-1">
                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Cari Jabatan</label>
                    <input
                        type="text"
        ...
        <div class="bg-white dark:bg-gray-800 rounded-sm border border-gray-200 dark:border-gray-700 shadow-sm">
            <div class="px-5 py-4 border-b border-gray-100 dark:border-gray-700/60 flex justify-between items-center">
                <div class="flex justify-between items-center w-full">
                    <h2 class="font-semibold text-gray-800 dark:text-gray-100">Daftar Jabatan</h2>
            ...
            <div class="p-3">
                    ...
                    <table class="table-auto w-full">
                        <thead>
                            <tr class="text-xs font-semibold uppercase text-gray-400 dark:text-gray-500 bg-gray-50 dark:bg-gray-700/30">
                                <th class="p-2 whitespace-nowrap text-left">Nama Jabatan</th>
                            ...
                            @forelse($positions as $position)
                                <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/30 transition-colors">
                                    <td class="p-2 whitespace-nowrap">
                                        <div class="font-medium text-gray-800 dark:text-gray-100">{{ $position->name }}</div>
                                    </td>
                                    <td class="p-2 whitespace-nowrap">
                                        <div class="text-gray-600 dark:text-gray-400">{{ $position->description ?? '-' }}</div>
                                    </td>
                                    <td class="p-2 whitespace-nowrap">
                                        <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full
                                            {{ $position->is_active ? 'bg-green-100 text-green-800 dark:bg-green-800/30 dark:text-green-500' : 'bg-red-100 text-red-800 dark:bg-red-800/30 dark:text-red-500' }}">
                                ...
                                <tr>
                                    <td colspan="4" class="p-8 text-center text-gray-500 dark:text-gray-400">
                                        <div class="flex flex-col items-center">
                                            ...
                                            <p class="text-sm mt-1">Silakan tambahkan data jabatan terlebih dahulu</p>
                                        </div>
                                    </td>
                                </tr>
                            @endforelse
                ...
                <!-- Pagination Links -->
                @if($positions && $positions->hasPages())
                    <div class="mt-4 px-3">
                        {{ $positions->links('pagination::livewire-tailwind') }}
                    </div>
                @endif
            </div>
        </div>
    ...
    <x-dialog-modal wire:model.live="showModal">
            ...
            <form wire:submit.prevent="savePosition">
                ...
                <div class="space-y-4">
                    ...
                    <div class="flex items-center">
                        ...
                        />
                        <label for="position_is_active" class="ml-2 block text-sm text-gray-700 dark:text-gray-300">
                            Aktif
                        </label>
                    </div>
                </div>
        ...
        <x-slot name="footer">
            ...
            <x-primary-button class="ms-3" wire:click="savePosition" wire:loading.attr="disabled">
    ...
    <x-confirmation-modal wire:model.live="showDeleteConfirmation">
        ...
        <x-slot name="content">
            ...
            <br><br>
            <strong>{{ $deletingPositionName ?? '' }}</strong>
            <br><br>
        ...
        <x-slot name="footer">
            ...
            <x-danger-button class="ms-3" wire:click="deletePosition" wire:loading.attr="disabled">
                Hapus
            </x-danger-button>
        </x-slot>
