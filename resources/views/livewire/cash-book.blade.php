<div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
    ...
    <!-- Form Section - Button to open modal and import/export -->
    <div class="bg-white dark:bg-gray-800 rounded-sm border border-gray-200 dark:border-gray-700 shadow-sm mb-8">
        <header class="px-5 py-4 border-b border-gray-100 dark:border-gray-700/60">
            <div class="flex flex-wrap justify-between items-center gap-4">
                <h2 class="font-semibold text-gray-800 dark:text-gray-100">Cash Transaction Input</h2>
                <div class="flex flex-wrap gap-2">
                    ...
                    <div class="relative group">
                        ...
                        <div class="absolute right-0 mt-0 w-48 bg-white dark:bg-gray-800 rounded-md shadow-lg py-1 z-10 hidden group-hover:block">
                            ...
                            <a 
                                href="{{ route('cashbook.sample.download') }}"
                                class="block w-full text-left px-4 py-2 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 flex items-center gap-2"
                            >
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                ...
                <table class="table-auto w-full">
                    <thead>
                        <tr class="text-xs font-semibold uppercase text-gray-400 dark:text-gray-500 bg-gray-50 dark:bg-gray-700/30">
                            ...
                            <th class="p-2 whitespace-nowrap">Purpose</th>
    ...
    <x-dialog-modal wire:model.live="showModal" maxWidth="2xl">
        <x-slot name="title">
            {{ $isEditing ? 'Edit Cash Transaction' : 'Add Cash Transaction' }}
        </x-slot>
    ...
    <x-confirmation-modal wire:model.live="showDeleteConfirmation">
        <x-slot name="title">
            {{ __('Delete Cash Transaction') }}
        </x-slot>

        <x-slot name="content">
            {{ __('Are you sure you want to delete the cash transaction ":name"?', ['name' => $deletingTransactionName]) }}
            {{ __('Once the transaction is deleted, all of its data will be permanently removed.') }}
        </x-slot>
        ...
        <x-slot name="content">
            @if($photoToView)
                <div class="flex justify-center">
                    <img src="{{ Storage::url($photoToView) }}" alt="Transaction Proof" class="max-w-full h-auto rounded-lg shadow-md">
                </div>
            @endif
        </x-slot>
        ...
        <x-slot name="content">
            <div class="mb-4">
                <p class="text-sm text-gray-600 dark:text-gray-400">
                    Upload an Excel file to import cash book data. The file should contain the following columns:
                </p>
                <ul class="mt-2 text-sm text-gray-600 dark:text-gray-400 list-disc list-inside">
                    <li><strong>transaction_date</strong> - Date of transaction (format: YYYY-MM-DD)</li>
                    <li><strong>transaction_type</strong> - Type: income or expense</li>
                    <li><strong>amount</strong> - Transaction amount</li>
                    <li><strong>purpose</strong> - Purpose of transaction</li>
