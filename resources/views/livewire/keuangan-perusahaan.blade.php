    ...
    <div class="bg-white dark:bg-gray-800 rounded-sm border border-gray-200 dark:border-gray-700 shadow-sm">
        ...
        <div class="p-3">
                ...
                <table class="table-auto w-full">
                    ...
                    <tbody class="text-sm divide-y divide-gray-100 dark:divide-gray-700/60">
                        @forelse($transactions as $transaction)
                            <tr id="transaction-{{ $transaction->id }}" class="{{ $loop->index % 2 == 0 ? 'bg-white dark:bg-gray-800' : 'bg-green-50 dark:bg-gray-800' }}">
            ...
            @if(isset($transactions) && $transactions->hasPages())
                <div class="mt-4 px-3">
                    {{ $transactions->links('pagination::livewire-tailwind') }}
                </div>
            @endif
        </div>
