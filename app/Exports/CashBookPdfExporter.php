...
class CashBookPdfExporter
{
    ...
    public function generate()
    {
        ...
        $html .= '<title>Cash Book Data Export</title>';
        $html .= '<style>';
        ...
        $html .= '<div>Laporan Buku Kas</div>';
        $html .= '</div>';
        $html .= '</div>';

        $html .= '<div class="document-title">';
        $html .= 'Cash Book Data Export';
        $html .= '</div>';
        ...
        foreach ($entries as $entry) {
            ...
            $html .= '<td>' . htmlspecialchars($entry->updated_at->format('Y-m-d H:i:s')) . '</td>';
            $html .= '</tr>';
        ...
        $html .= '<p>Total Records: ' . count($entries) . '</p>';
